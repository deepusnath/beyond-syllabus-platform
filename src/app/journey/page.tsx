  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
      <SectionHeading
        ...
        lede="The objective is not another discussion about what is wrong with education. The objective is to build credible alternatives. Each stage adds a stakeholder group and carries forward everything gathered before it — until, on Republic Day, the record passes into the hands of the people who can act on it."
      />
