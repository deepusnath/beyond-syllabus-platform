...
export const events: Event[] = [
  ...
  },
  {
    ...
    format: "hybrid",
    description:
      "The evidence, ideas and prototypes are consolidated into practical recommendations and submitted to the relevant Union Ministry — the public record of what four months of structured conversation produced.",
    confirmed: true,
  },
];
